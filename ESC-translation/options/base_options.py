...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='/media/nuo/3312A4E89699CEBC/soft_X_seg/sxt2em_code_data/sxt2em_crop_512_for_style_transfer', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--name', type=str, default='sxt2em', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--pre_trained_path', type=str,default=0,help='path to the pre-trained resnet architecture')
